...
from llava.train.llava_trainer import LLaVATrainer, LLaVaORPOTrainer
...
class ORPODataset(Dataset):
    def __init__(self,
                 tokenizer: transformers.PreTrainedTokenizer,
                 multimodal_cfg: dict):
        super(ORPODataset, self).__init__()

        self.tokenizer = tokenizer
        self.data_dir = os.path.dirname(multimodal_cfg['data_path'])
        with open(multimodal_cfg['data_path'], 'r') as f:
...
def make_orpo_data_module(tokenizer, data_args):
